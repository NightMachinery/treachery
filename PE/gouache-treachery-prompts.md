# Gouache Treachery image prompts

Prompts are handcrafted from `PE/image-gouache-1-template.md`. Common constraints for each generated image: gallery-grade modern editorial gouache, 7:10 portrait requested as 1050x1500, full bleed, no text/letters/numbers/logos/watermarks/borders, calm lower 20% for later card label, main subject in the central safe zone.

## 2026-04-24 checkpoint 1

### means/default.png — means fallback

- Gameplay function: generic Means fallback card; communicates dangerous method without naming a specific card.
- Main subject: crossed polished steel blade and small glass vial on a dark forensic tabletop.
- Supporting cues: faint chalk evidence marks, muted evidence tag shape, abstract crimson accent.
- Mood/setting: elegant, forensic, ominous; Hong Kong noir suggested by blurred window lights.
- Palette/lighting/composition: smoky blue-black, bone neutrals, restrained crimson, pale steel; narrow top-left spotlight; centered slight top-down still life.

### clues/default.png — clues fallback

- Gameplay function: generic Clue fallback card; communicates physical evidence.
- Main subject: cream evidence envelope with a magnifying glass crossing it diagonally.
- Supporting cues: dust motes under the lens, faint shoeprint fragment, small ribbon of shadow.
- Mood/setting: investigative, quiet, uncanny; dim detective desk with rainy urban window ambience.
- Palette/lighting/composition: parchment and umber with cool slate shadows and teal lens reflection; diffuse upper-right window light; asymmetrical diagonal still life.

### means/001-alcohol.png — Alcohol

- Gameplay function: Means card; makes alcohol readable as a possible method or enabling substance.
- Main subject: cut-crystal tumbler half-filled with amber liquor, large and close, with an unlabeled bottle silhouette behind it.
- Supporting cues: tipped ice cube, crescent of spilled liquid, blurred bar-shelf glow.
- Mood/setting: decadent, ominous, late-night; private club or apartment bar.
- Palette/lighting/composition: amber gold and burnt sienna against bottle-green/charcoal shadows; warm low side light through glass; close-up low eye-level still life.

### clues/001-air-conditioning.png — Air Conditioning

- Gameplay function: Clue card; makes an air-conditioning unit readable as suspicious physical evidence.
- Main subject: off-white wall-mounted air conditioner, vents open, condensation and cold mist.
- Supporting cues: dangling loose screw, condensation puddle, subtle frost along vent.
- Mood/setting: sterile, chilly, uncanny; slightly neglected modern apartment wall.
- Palette/lighting/composition: porcelain whites, pale blues, gray-green wall, tiny amber reflection; cold fluorescent top light plus blue vent glow; straight-on iconic view.

### means/002-amoeba.png — Amoeba

- Gameplay function: Means card; makes an amoeba readable as a biological microscopic hazard.
- Main subject: large translucent amoeba under a circular microscope view with soft pseudopods.
